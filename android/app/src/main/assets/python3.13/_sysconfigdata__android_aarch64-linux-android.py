...
build_time_vars = {
    ...
    'AR': '/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar',
    'ARFLAGS': 'rcs',
    'BASECFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code',
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/bin',
    'BINLIBDEST': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13',
    'BLDLIBRARY': '-L. -lpython3.13',
    'BLDSHARED': '/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang -shared -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.exe',
    ...
    'BYTESTR_DEPS': '\\',
    'CC': '/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang',
    'CCSHARED': '-fPIC',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong',
    ...
    'CONFIGURE_CFLAGS': '-fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '-fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--host=aarch64-linux-android' '--build=x86_64-linux-gnu' '--enable-shared' '--with-build-python=/mnt/d/Projects/RN-Python-Java/python/build_android/host-python/bin/python3' '--without-ensurepip' '--disable-test-modules' '--with-pkg-config=no' '--prefix=/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output' 'ac_cv_file__dev_ptmx=no' 'ac_cv_file__dev_ptc=no' 'ac_cv_func_fork=no' 'ac_cv_func_fork_works=no' 'ac_cv_func_vfork=no' 'ac_cv_func_vfork_works=no' 'ac_cv_func_system=no' 'ac_cv_func_pipe=no' 'ac_cv_func_pipe2=no' 'ac_cv_func_dlopen=yes' 'ac_cv_func_dlclose=yes' 'ac_cv_func_dlsym=yes' 'ac_cv_have_long_long_format=yes' 'ac_cv_have_int_max=yes' 'ac_cv_have_long_double=yes' 'ac_cv_c_bigendian=no' 'ac_cv_cxx_compile_cxx17=yes' 'ac_cv_func_stat64=yes' 'ac_cv_func_fstat64=yes' 'ac_cv_func_lstat64=yes' 'ac_cv_func_fstatat64=yes' 'ac_cv_header_libintl_h=no' 'ac_cv_lib_intl_textdomain=no' 'ac_cv_lib_intl_bindtextdomain=no' 'ac_cv_lib_intl_gettext=no' 'ac_cv_lib_ffi_ffi_call=no' 'ac_cv_lib_bz2_BZ2_bzlibVersion=no' 'ac_cv_lib_lzma_lzma_code=no' 'ac_cv_lib_uuid_uuid_generate=no' 'ac_cv_lib_ssl_SSL_new=no' 'ac_cv_lib_crypto_CRYPTO_new_ex_data=no' 'ac_cv_lib_sqlite3_sqlite3_open=no' 'ac_cv_lib_readline_readline=no' 'ac_cv_lib_ncursesw_initscr=no' 'ac_cv_lib_panelw_new_panel=no' 'build_alias=x86_64-linux-gnu' 'host_alias=aarch64-linux-android' 'CC=/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang' 'CFLAGS=-fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong' 'LDFLAGS=-fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so'",
    'CONFINCLUDEDIR': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/include',
    'CONFINCLUDEPY': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/mnt/d/Projects/RN-Python-Java/python/Python-3.13.14/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/mnt/d/Projects/RN-Python-Java/python/Python-3.13.14/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': '/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang++',
    'DESTDIRS': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output /mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib /mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13 /mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13/lib-dynload',
    'DESTLIB': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'FILEMODE': 644,
    'FREEZE_MODULE': '/mnt/d/Projects/RN-Python-Java/python/build_android/host-python/bin/python3 ./Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/mnt/d/Projects/RN-Python-Java/python/build_android/host-python/bin/python3 ./Programs/_freeze_module.py',
    ...
    'INCLDIRSTOMAKE': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/include /mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/include /mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/include/python3.13 /mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/include/python3.13',
    'INCLUDEDIR': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/include',
    'INCLUDEPY': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/include/python3.13',
    ...
    'INSTSONAME': 'libpython3.13.so',
    'IO_H': 'Modules/_io/_iomodule.h',
    'IO_OBJS': '\\',
    'IPHONEOS_DEPLOYMENT_TARGET': '',
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang++ -shared -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so',
    'LDFLAGS': '-fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang -shared -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13',
    'LIBDIR': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/pkgconfig',
    'LIBPL': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13/config-3.13-aarch64-linux-android',
    ...
    'LIBS': '-ldl  -llog',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang',
    ...
    'LLVM_PROF_MERGER': '/home/ayush/Android/Sdk/ndk/android-ndk-r27b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-profdata merge -output="$(shell pwd)/code.profclangd" "$(shell pwd)"/*.profclangr',
    'LN': 'ln',
    'LOCALMODLIBS': '',
    'MACHDEP': 'android',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/share/man',
    'MIMALLOC_HEADERS': '\\',
    'MKDIR_P': '/usr/bin/mkdir -p',
    'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  _json  _lsprof  _opcode  _pickle  _queue  _random  _struct  _interpreters  _interpchannels  _interpqueues  _zoneinfo  math  cmath  _statistics  _datetime  _decimal  binascii  zlib  _md5  _sha1  _sha2  _sha3  _blake2  pyexpat  _elementtree  _codecs_cn  _codecs_hk  _codecs_iso2022  _codecs_jp  _codecs_kr  _codecs_tw  _multibytecodec  unicodedata  fcntl  mmap  resource  select  _socket  syslog  termios  atexit  faulthandler  posix  _signal  _tracemalloc  _suggestions  _codecs  _collections  errno  _io  itertools  _sre  _sysconfig  _thread  time  _typing  _weakref  _abc  _functools  _locale  _operator  _stat  _symtable  pwd',
    'MODDISABLED_NAMES': '',
    'MODLIBS': '',
    ...
    'MODULE_DEPS_SHARED': 'Modules/config.c  libpython3.13.so',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/mnt/d/Projects/RN-Python-Java/python/Python-3.13.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__android_aarch64-linux-android _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /mnt/d/Projects/RN-Python-Java/python/Python-3.13.14/`cat pybuilddir.txt`) /mnt/d/Projects/RN-Python-Java/python/build_android/host-python/bin/python3',
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/mnt/d/Projects/RN-Python-Java/python/build_android/host-python/bin/python3',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha2,sha3,blake2"',
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so',
    'PY_CPPFLAGS': '-I. -I./Include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so -fPIC -L/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib -Wl,-soname,libpython3.13.so',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 0,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -fPIC -march=armv8-a -D__ANDROID__ -DANDROID -fstack-protector-strong -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'PY_SUPPORT_TIER': 3,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib',
    'SCRIPT_IDLE': 'build/scripts-3.13/idle3.13',
    'SCRIPT_PYDOC': 'build/scripts-3.13/pydoc3.13',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-313-aarch64-linux-android.so Modules/_asyncio.cpython-313-aarch64-linux-android.so Modules/_bisect.cpython-313-aarch64-linux-android.so Modules/_contextvars.cpython-313-aarch64-linux-android.so Modules/_csv.cpython-313-aarch64-linux-android.so Modules/_heapq.cpython-313-aarch64-linux-android.so Modules/_json.cpython-313-aarch64-linux-android.so Modules/_lsprof.cpython-313-aarch64-linux-android.so Modules/_opcode.cpython-313-aarch64-linux-android.so Modules/_pickle.cpython-313-aarch64-linux-android.so Modules/_queue.cpython-313-aarch64-linux-android.so Modules/_random.cpython-313-aarch64-linux-android.so Modules/_struct.cpython-313-aarch64-linux-android.so Modules/_interpreters.cpython-313-aarch64-linux-android.so Modules/_interpchannels.cpython-313-aarch64-linux-android.so Modules/_interpqueues.cpython-313-aarch64-linux-android.so Modules/_zoneinfo.cpython-313-aarch64-linux-android.so Modules/math.cpython-313-aarch64-linux-android.so Modules/cmath.cpython-313-aarch64-linux-android.so Modules/_statistics.cpython-313-aarch64-linux-android.so Modules/_datetime.cpython-313-aarch64-linux-android.so Modules/_decimal.cpython-313-aarch64-linux-android.so Modules/binascii.cpython-313-aarch64-linux-android.so Modules/zlib.cpython-313-aarch64-linux-android.so Modules/_md5.cpython-313-aarch64-linux-android.so Modules/_sha1.cpython-313-aarch64-linux-android.so Modules/_sha2.cpython-313-aarch64-linux-android.so Modules/_sha3.cpython-313-aarch64-linux-android.so Modules/_blake2.cpython-313-aarch64-linux-android.so Modules/pyexpat.cpython-313-aarch64-linux-android.so Modules/_elementtree.cpython-313-aarch64-linux-android.so Modules/_codecs_cn.cpython-313-aarch64-linux-android.so Modules/_codecs_hk.cpython-313-aarch64-linux-android.so Modules/_codecs_iso2022.cpython-313-aarch64-linux-android.so Modules/_codecs_jp.cpython-313-aarch64-linux-android.so Modules/_codecs_kr.cpython-313-aarch64-linux-android.so Modules/_codecs_tw.cpython-313-aarch64-linux-android.so Modules/_multibytecodec.cpython-313-aarch64-linux-android.so Modules/unicodedata.cpython-313-aarch64-linux-android.so Modules/fcntl.cpython-313-aarch64-linux-android.so Modules/mmap.cpython-313-aarch64-linux-android.so Modules/resource.cpython-313-aarch64-linux-android.so Modules/select.cpython-313-aarch64-linux-android.so Modules/_socket.cpython-313-aarch64-linux-android.so Modules/syslog.cpython-313-aarch64-linux-android.so Modules/termios.cpython-313-aarch64-linux-android.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl  -llog',
    'SHLIB_SUFFIX': '.so',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': '_PYTHON_PROJECT_BASE=/mnt/d/Projects/RN-Python-Java/python/Python-3.13.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__android_aarch64-linux-android _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /mnt/d/Projects/RN-Python-Java/python/Python-3.13.14/`cat pybuilddir.txt`) /mnt/d/Projects/RN-Python-Java/python/build_android/host-python/bin/python3',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': '_PYTHON_PROJECT_BASE=/mnt/d/Projects/RN-Python-Java/python/Python-3.13.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__android_aarch64-linux-android _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /mnt/d/Projects/RN-Python-Java/python/Python-3.13.14/`cat pybuilddir.txt`) /mnt/d/Projects/RN-Python-Java/python/build_android/host-python/bin/python3 -m test',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output',
    'WASM_STDLIB': './mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'abs_builddir': '/mnt/d/Projects/RN-Python-Java/python/Python-3.13.14',
    'abs_srcdir': '/mnt/d/Projects/RN-Python-Java/python/Python-3.13.14',
    'datarootdir': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output/share',
    'exec_prefix': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output',
    'prefix': '/mnt/d/Projects/RN-Python-Java/python/build_android/arm64-v8a/output',
    'srcdir': '.',
}
