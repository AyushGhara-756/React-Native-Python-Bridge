...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': 'iOS/Frameworks//bin',
    'BINLIBDEST': 'iOS/Frameworks//lib/python3.13',
    'BLDLIBRARY': '',
    'BLDSHARED': '/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang -dynamiclib -F . -framework Python -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.exe',
    ...
    'CCSHARED': '',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0',
    'CFLAGSFORSHARED': '',
    ...
    'CONFIGURE_CFLAGS': '-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -mios-version-min=13.0',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--host=arm64-apple-ios' '--build=arm64-apple-darwin' '--disable-shared' '--enable-framework' '--without-ensurepip' '--disable-test-modules' '--with-build-python=/opt/homebrew/bin/python3.13' '--with-pkg-config=no' 'ac_cv_file__dev_ptmx=no' 'ac_cv_file__dev_ptc=no' 'ac_cv_func_fork=no' 'ac_cv_func_fork_works=no' 'ac_cv_func_forkpty=no' 'ac_cv_func_vfork=no' 'ac_cv_func_system=no' 'ac_cv_func_pipe=no' 'ac_cv_func_pipe2=no' 'ac_cv_func_dlopen=no' 'ac_cv_func_dlclose=no' 'ac_cv_func_dlsym=no' 'ac_cv_have_long_long_format=yes' 'ac_cv_type_uid_t=yes' 'ac_cv_type_gid_t=yes' 'ac_cv_type_pid_t=yes' 'ac_cv_type_mode_t=yes' 'ac_cv_type_off_t=yes' 'ac_cv_type_size_t=yes' 'ac_cv_type_ssize_t=yes' 'ac_cv_type_time_t=yes' 'ac_cv_type_clock_t=yes' 'ac_cv_sizeof_int=4' 'ac_cv_sizeof_long=8' 'ac_cv_sizeof_long_long=8' 'ac_cv_sizeof_void_p=8' 'ac_cv_sizeof_short=2' 'ac_cv_sizeof_float=4' 'ac_cv_sizeof_double=8' 'ac_cv_sizeof_size_t=8' 'ac_cv_sizeof_fpos_t=8' 'ac_cv_sizeof__Bool=1' 'ac_cv_alignof_long=8' 'ac_cv_alignof_double=8' 'ac_cv_alignof_max_align_t=8' 'ac_cv_have_int_max=yes' 'ac_cv_have_long_double=yes' 'ac_cv_c_bigendian=no' 'ac_cv_member_struct_stat_st_mtim=yes' 'ac_cv_func_stat64=yes' 'ac_cv_func_fstat64=yes' 'ac_cv_func_lstat64=yes' 'ac_cv_func_fstatat64=yes' 'ac_cv_header_ffi_h=no' 'ac_cv_lib_ffi_ffi_call=no' 'ac_cv_lib_bz2_BZ2_bzlibVersion=no' 'ac_cv_lib_lzma_lzma_code=no' 'ac_cv_lib_uuid_uuid_generate=no' 'build_alias=arm64-apple-darwin' 'host_alias=arm64-apple-ios' 'CC=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang' 'CFLAGS=-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0' 'LDFLAGS=-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1' 'CPP=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang -E'",
    'CONFINCLUDEDIR': 'iOS/Frameworks//include',
    'CONFINCLUDEPY': 'iOS/Frameworks//include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14/lcov-report',
    ...
    'DESTDIRS': 'iOS/Frameworks/ iOS/Frameworks//lib iOS/Frameworks//lib/python3.13 iOS/Frameworks//lib/python3.13/lib-dynload',
    'DESTLIB': 'iOS/Frameworks//lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': 'iOS/Frameworks//lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': 'iOS/Frameworks//bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    'EXT_SUFFIX': '.cpython-313.so',
    'FILEMODE': 644,
    'FREEZE_MODULE': '/opt/homebrew/bin/python3.13 ./Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/opt/homebrew/bin/python3.13 ./Programs/_freeze_module.py',
    ...
    'INCLDIRSTOMAKE': 'iOS/Frameworks//include iOS/Frameworks//include iOS/Frameworks//include/python3.13 iOS/Frameworks//include/python3.13',
    'INCLUDEDIR': 'iOS/Frameworks//include',
    'INCLUDEPY': 'iOS/Frameworks//include/python3.13',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++ -dynamiclib -F . -framework Python -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1',
    'LDFLAGS': '-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'Python.framework/Python',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang -dynamiclib -F . -framework Python -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': 'iOS/Frameworks//lib/python3.13',
    'LIBDIR': 'iOS/Frameworks//lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': 'iOS/Frameworks//lib/pkgconfig',
    'LIBPL': 'iOS/Frameworks//lib/python3.13/config-3.13',
    'LIBPYTHON': '',
    ...
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang',
    ...
    'PYTHONFRAMEWORKINSTALLDIR': 'iOS/Frameworks//Python.framework',
    'PYTHONFRAMEWORKINSTALLNAMEPREFIX': '@rpath/Python.framework',
    'PYTHONFRAMEWORKPREFIX': 'iOS/Frameworks/',
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__ios_ _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14/`cat pybuilddir.txt`) /opt/homebrew/bin/python3.13',
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/opt/homebrew/bin/python3.13',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha2,sha3,blake2"',
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1',
    'PY_CPPFLAGS': '-I. -I./Include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -mios-version-min=13.0 -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk -miphoneos-version-min=15.1 -D_FORTIFY_SOURCE=0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'PY_SUPPORT_TIER': 3,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 0,
    'Py_GIL_DISABLED': 0,
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': 'iOS/Frameworks//lib',
    'SCRIPT_IDLE': 'build/scripts-3.13/idle3.13',
    'SCRIPT_PYDOC': 'build/scripts-3.13/pydoc3.13',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-313.so Modules/_asyncio.cpython-313.so Modules/_bisect.cpython-313.so Modules/_contextvars.cpython-313.so Modules/_csv.cpython-313.so Modules/_heapq.cpython-313.so Modules/_json.cpython-313.so Modules/_lsprof.cpython-313.so Modules/_opcode.cpython-313.so Modules/_pickle.cpython-313.so Modules/_queue.cpython-313.so Modules/_random.cpython-313.so Modules/_struct.cpython-313.so Modules/_interpreters.cpython-313.so Modules/_interpchannels.cpython-313.so Modules/_interpqueues.cpython-313.so Modules/_zoneinfo.cpython-313.so Modules/math.cpython-313.so Modules/cmath.cpython-313.so Modules/_statistics.cpython-313.so Modules/_datetime.cpython-313.so Modules/_decimal.cpython-313.so Modules/binascii.cpython-313.so Modules/_bz2.cpython-313.so Modules/zlib.cpython-313.so Modules/_dbm.cpython-313.so Modules/_md5.cpython-313.so Modules/_sha1.cpython-313.so Modules/_sha2.cpython-313.so Modules/_sha3.cpython-313.so Modules/_blake2.cpython-313.so Modules/pyexpat.cpython-313.so Modules/_elementtree.cpython-313.so Modules/_codecs_cn.cpython-313.so Modules/_codecs_hk.cpython-313.so Modules/_codecs_iso2022.cpython-313.so Modules/_codecs_jp.cpython-313.so Modules/_codecs_kr.cpython-313.so Modules/_codecs_tw.cpython-313.so Modules/_multibytecodec.cpython-313.so Modules/unicodedata.cpython-313.so Modules/fcntl.cpython-313.so Modules/mmap.cpython-313.so Modules/resource.cpython-313.so Modules/select.cpython-313.so Modules/_socket.cpython-313.so Modules/termios.cpython-313.so Modules/_sqlite3.cpython-313.so Modules/_uuid.cpython-313.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl  -lpthread -lutil',
    'SHLIB_SUFFIX': '.so',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': '_PYTHON_PROJECT_BASE=/Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__ios_ _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14/`cat pybuilddir.txt`) /opt/homebrew/bin/python3.13',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': '_PYTHON_PROJECT_BASE=/Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__ios_ _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14/`cat pybuilddir.txt`) /opt/homebrew/bin/python3.13 -m test',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': '.iOS/Frameworks/',
    'WASM_STDLIB': '.iOS/Frameworks//lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'abs_builddir': '/Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14',
    'abs_srcdir': '/Users/anand/Documents/dev/rn-python/RNPythonBridge/python/Python-3.13.14',
    'datarootdir': 'iOS/Frameworks//share',
    'exec_prefix': 'iOS/Frameworks/',
    'prefix': 'iOS/Frameworks/',
    'srcdir': '.',
}
